...
const MagicBento: React.FC<ChromaGridProps> = ({
  items,
  className = '',
  radius = 300,
  damping = 0.45,
    ...
    >
      {data.map((c, i) => (
        <article
          ...
          className="group relative flex flex-col w-full h-full rounded-3xl overflow-hidden border-2 border-transparent transition-colors duration-300 cursor-pointer"
          style={
            {
