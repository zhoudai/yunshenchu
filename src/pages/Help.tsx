...
const Help = () => {
  ...
  const tabs = [
    { id: "faq", name: "常见问题" },
    { id: "troubleshoot", name: "故障排查" },
    { id: "guides", name: "使用指南" },
    { id: "support", name: "售后支持" },
  ];
  ...
  return (
    ...
    />
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-xl text-muted-foreground">{t('获取常见问题、故障排查与使用指南')}</p>
        </div>
      </section>
                  ...
                  <div className="flex gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                        <span>{t('版本')}: {file.version}</span>
                        <span>{t('日期')}: {file.date}</span>
                        <span>{t('大小')}: {file.size}</span>
